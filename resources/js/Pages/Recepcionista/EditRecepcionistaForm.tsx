...
import { RecepcionistaFormProps } from '@/types';


const EditRecepcionistaForm: React.FC<RecepcionistaFormProps> = ({ recepcionista, onClose }) => {
    const { data, setData, put, errors, processing } = useForm({
        name: recepcionista.name,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(`/recepcionista/${recepcionista.id}`, {
            onSuccess: () => {
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: '¡Guardado!',
                    text: 'Recepcionista actualizado exitosamente.',
            ...
            onError: () => {
                ...
                Swal.fire({
                    ...
                    text: errorMessages || 'Por favor, revisa los datos ingresados y vuelve a intentarlo.',
                    icon: 'error',
    ...
    return (
        <>
            <Head title="Edición de Recepcionista" />
...
export default EditRecepcionistaForm;
